...
z.B.: (5) Sein Freund *ist* gestern um 11 Uhr [angekommen]{.underline}.\
...
(2) Auf der Brücke konnte man die Gefahr [geradezu]{.underline} spüren.\
(3) Es geht - [wie ich sagen möchte]{.underline} - um eine alte Bekannte.\
(4) Es geht [gewissermaßen]{.underline} um eine alte Bekannte.\
(5) Sie ist [einfach]{.underline} bezaubernd.

-   **Syntagmatische Eigenschaften:** Verschiebung nur teilweise möglich:\

(6) Es geht um eine alte Bekannte, [wie ich sagen möchte]{.underline}.\
(7) [Gewissermaßen]{.underline} geht es um eine alte Bekannte.
...
(8) Du müßtest [besonders]{.underline} achtgeben.\
(9) [Besonders]{.underline} du müßtest achtgeben.\
(10) [Vor allem]{.underline} muß man\* auf \*Pünktlichkeit achten.
...
-   **Funktion**:\
    Äußerungen in Beziehung zu anderen (bzw. Teilen davon).
...
-   **Formen**:\
    ...
    **Ausdrücke** wie *auf der einen / anderen Seite, darüberhinaus, im übrigen, in erster Linie, unter anderem, zum Beispiel z.B.)*.

-   **Syntagmatische Eigenschaften**: Bis auf *nur* und *nun* meist frei verschiebbar.

(10a) Wir haben [allerdings]{.underline} nichts davon gewußt.
(Helbig 1988: Abtönungspartikel - AP)\
(10b) [Allerdings]{.underline} haben wir nichts davon gewußt.\
(11) Er ist [immerhin / schließlich]{.underline} dein Vater.
(Helbig 1988: AP)\
(12) [Nun / Nur]{.underline} konnte er das nicht wissen.\
(13) Der Motor war [sowieso]{.underline} schon veraltet.
(Helbig 1988: AP)\
(14) Mir war das [übrigens]{.underline} bekannt.
(Helbig 1988: AP)\
(15) [Zwar]{.underline} weiß ich viel, doch möcht' ich alles wissen.
(Goethe)

#### Judikative Angaben

-   **Funktion**:\
    Bewertung des Sachverhalt durch Sprecher; Orientierung auf Satz.

-   **Formen**: **Modalpartikeln** und **Rangierpartikeln** mit Ableitungssuffix *-weise* (z.B. *bedauerlicherweise, bemerkenswerterweise, begreiflicherweise, erfreulicherweise, glücklicherweise, interessanterweise, seltsamerweise, unglücklicherweise, verständlicherweise*).\
...
(16a) Er hat das [*bemerkenswerterweise*]{.underline} nicht erwähnt.\
(16b) [*Bemerkenswerterweise*]{.underline} hat er das nicht erwähnt.\
(17) Es ist [*glücklicherweise*]{.underline} nichts passiert.\
(18) Das hat sie [*verständlicherweise*]{.underline} verschwiegen.\
(19) Sie kann es [*leider*]{.underline} nicht besser.
...
(20) Sie hat es wieder nicht geschafft, [*was mir sehr leid tut*]{.underline}.\
(21) [Was]{.underline} [*mir sehr leid tut*]{.underline}: Sie hat es wieder nicht geschafft.\
(22) Sie hat es, [*was mir sehr leid tut*]{.underline}, wieder nicht geschafft.

#### Verfifikative Angaben

-   **Funktion**:\
    modifizieren Realitätsgrad eines Sachverhaltes (illokutiv orientiert).
...
-   **Formen**:\
    ...
    **Nebensätze** *wie sich leicht nachweisen läßt, wie ich hoffe;* **parenthetische Hauptsätze** wie - (so) *hoffe ich -*.

-   **Vorkommensbeschränkungen**:\
    meist in Aussagen, gelegentlich in Fragen.

(23a) Dies ist [*bekanntlich*]{.underline} nicht das erste Mal.\
(23b) [*Bekanntlich*]{.underline} ist dies nicht das erste Mal.\
(23c) Dies ist nicht das erste Mal [*bekanntlich*]{.underline}.\
(24) Er ist [*notwendigerweise*]{.underline} mitschuldig.\
(25) Sie könnte [*vielleicht*]{.underline} etwas wissen.\
(26) Hätten Sie [*vielleicht*]{.underline} etwas Zucker?\
(27) [*Eigentlich*]{.underline} müßte sie das wissen.\
(28) Wir werden Ihnen [*selbstverständlich*]{.underline} den Schaden ersetzen.\
(29) Er hat [*mit Sicherheit*]{.underline} den Täter gesehen.

-   **Syntagmatische Eigenschaften**: frei verschiebbar.

(30a) [*Wie sich leicht nachweisen läßt*]{.underline}, hat sie in allem recht.\
(30b) Sie hat, [*wie sich leicht nachweisen läßt*]{.underline}, in allem recht.\
(30c) Sie hat in allem recht, [*wie sich leicht nachweisen läßt*]{.underline}.\
(31a) Sie kann den Täter identifizieren, [*hoffe ich*]{.underline}.\
(31b) Sie kann, [*(so) hoffe ich*]{.underline}, den Täter identifizieren.

#### Abtönungspartikeln

-   **Funktion**: Orientierung auf illokutive Komponente der Äußerung; Redeabsicht modifizieren, zu verstärken, abzumildern o.ä.

(32) Der hat [*aber*]{.underline} einen Bart!\
(33) Ist das [*aber*]{.underline} kalt!\
(34) Franz hatte einen Kreislaufkollaps. - Der hat sich [*ja auch*]{.underline} nie geschont.\
(35) Es gibt wieder eine Weinschwemme, was [*ja*]{.underline} nach dem regnerischen Sommer [*auch*]{.underline} nicht anders zu erwarten war.\
(36) Hast du [*auch*]{.underline} alles eingepackt?\
(37) Wie alt bist du [*denn*]{.underline}?\
(38) Ist er [*denn*]{.underline} wirklich schon zu alt dafür?\
(39) Wo kann man [*denn*]{.underline} hier telefonieren?
...
(40) Du bist [*mir*]{.underline} ein schöner Freund!\
     (41a) Du wirst [*mir*]{.underline} noch aus dem Fenster fallen!\
     (41b) Fall [*mir*]{.underline} nicht aus dem Fenster!\
     (41c) Daß du [*mir*]{.underline} nicht aus dem Fenster fälltst!\
(41) Der wird [*dir*]{.underline} noch die ganze Konstruktion verwässern.\
(42) Und daß du [*mir*]{.underline} nicht der [*Tante Emma*]{.underline} von diesem Ausflug erzählst!\
(43) Sie kann [*dir dem General der Heilsarmee*]{.underline} ein Glas Wein anbieten.


:::rmdrobot

Bestimmten Sie, welche Angabeklassen in Andersens Märchen vorkommen (Beschreibung der Bedeutung, eine charakteristische Frage und Anapher für die Identifizierung der Angabe, den Namen der Angabeklasse)!

Adresse der gemeinsamen Google-Tabelle:    https://docs.google.com/spreadsheets/d/1TXU64zYDXU9gpPyQJYORe3I91KQ8SRbuaIVJB0GCW9o/edit?usp=sharing

Bei Abtönungspartikeln sind entsprechende Beschreibungen bereits in die gemeinsame Tabelle eingetragen. 
...
1. Beschreiben Sie in einem oder zwei Sätzen, wodurch sich existimatorische Angaben von den anderen Angabeklassen unterscheiden! Illustrieren Sie Ihre Bechreibung mit zwei Beispielen! 
...
Enthält ein satzartiges Konstrukt jedoch mehr als eine Verbform, so können zentrales Verb und finites Verb nicht identisch sein.
Dann wird aus diesen Verbformen ein **Verbalkomplex** gebildet.
...
1.  das zentrale Verb (finit oder infinit) [das in der folgenden Beschreibung ausgelassen wird],\
2.  trennbare Verbzusätze (Verbpräfixe und die 1. unmittelbare Konstituente in Zusammensetzungen) (z.B. [*an*]{.underline}*kommen, [unter]{.underline}gehen*),\
3.  Modalverben (*können, müssen, wollen,...*),\
4.  zeiten- und passivbildende Auxiliarverben\* (*haben, sein, werden*),\
5.  Reflexivpronomina (in Verbindung mit bestimmten Verben),\
...
· [Auxiliarverben]{.underline} (*haben, sein, werden*),\
· [Modalverben]{.underline} (*können, müssen, sollen,...*),\
· [Modalitätsverben]{.underline} (*scheinen, pflegen, sich trauen, ...*),\
...
· [Nebensatzverben]{.underline}, [Infinitivverben]{.underline}, [Partizipverben]{.underline},\
· [trennbare Verbzusätze]{.underline},\
· [Reflexivpronomina]{.underline},\
· [Pronomen *es*]{.underline},\
· lexikalische Fügungen ([Gefügenomina]{.underline}).

Situativverben: *sein, bleiben, haben* + Infinitiv (ohne *zu*)

z.B.
(36) Ich würde heute lieber im Bett *liegen* [bleiben]{.underline}.\
(37) Sie [hat]{.underline} unheimlich viel Krimskrams in ihrem Zimmer *herumliegen*.\
(38) Der Tisch soll so *stehen* [bleiben]{.underline}.
 ...
 **Adjektive** ([krank]{.underline}melden, [breit]{.underline}treten),

 **Adverbien** ([weiter]{.underline}erzählen, [wieder]{.underline}geben),

**Nomina** / **Präpositionen + Nomina** ([rad]{.underline}fahren
- Rad fahren, [zutage]{.underline}treten - zu Tage treten) - [nach der neuen Rechtschreibung keine
Zusammensetzungen !!!]
,

selten: **Verben** ([kennen]{.underline}lernen - kennen
lernen, [liegen]{.underline}bleiben - liegen bleiben) - [nach der neuen Rechtschreibung keine
Zusammensetzungen mehr!!!]
.



Bei den Verben mit Verbzusatz besteht das Problem,
zwischen echten komplexen Verben einerseits und Simplex mit freier Ergänzung zu
unterscheiden.
**Kriterien zur
Unterscheidung:**

**1. Komplexes Verb oder Simplex
+ E~dir~ ?** (Pseudoverbkomplex[°](#_ftn1) )

a\.
Kommutiert das fragliche Element mit
Präpositionalphrasen der E~6~ (E~dir~)?
...
(2)  Der Gast geht  hinein
.

   ins
Hotel (hinein) .

(3)  Der Fuchs kommt  heraus
.
...
Die Adverbien
sind fakultativ, mit der Präposition korresporendierende Teile der Edir



b\.
Ergibt die
Kommutation des Simplex mit bedeutungsähnlichen Verben akzeptable Sätze?
...
Die Anaphorisierungsprobe ist nicht durchführbar,
weil die Pronominaladverbien Anaphern sind.



Wenn die beiden Proben positiv ausfallen, dann ist
das fragliche Element eindeutig als E~6~

(E~dir~) klassifizierbar.
Damit sind **Pseudoverbkomplexe** (Verben +
Pseudoverbzusatz) erwiesen (die folgenden Beispiele nach der Rechtschreibung
bis 1998):

z.B.
 *hinausklettern, hinübersetzen,
dazwischenstellen, zurückgehen, fortlaufen, wegrennen, herunterfallen*.

(vgl. Fleischer!)



**2. Komplexes Verb oder Simplex + E~sit~?**

Zur Identifikation können Proben angewandt
werden, die den oben durchgeführten entsprechen:

a\.
Kommutierbarkeit mit
Präpositionalphrase (E~sit~)?

b\.
Kommutation mit Synonymen u.a.
-- akzeptable Sätze?

z.B.
 (5)  Es stand ein alter Nußbaum  [davor]{.underline}.

   vor dem Haus.

(6)  Die Katze sitzt fast immer  [dahinter]{.underline}.
...
**3. Komplexes Verb oder Simplex + E~adj~ (E~8~)?**

a\.
**Anaphorisierungsprobe** (*so, es, das* ® E~8~)
bzw.
**Erfragbarkeit** durch
Fragepartikel *wie*?

z.B.
 (8)  Macht ihre Antwort dich [glücklich]{.underline}?
 + + (Adjektivalergänzung)

(9)  Du kannst mir nichts [weis]{.underline}machen.
 - - (Teil des Verbkomplexes)

b\.
Kann das adjektivische Element **im eingeleiteten Nebensatz** bei
einteiliger Konjugationsform vom V~f~ **getrennt** werden?
(Fall Probe *a* negativ ausfällt, ist *b* zweifelhaft)
...
gefahren, ...)
 ...
 (2)
 Ich [muss]{.underline} leider nach Hause.
 (gehen, fahren,...)

(3)  Ich
[möchte]{.underline} noch gern eine Tasse Tee.
 (haben)
...
· und Infinitivkonstruktion als Verbativergänzung
E~vrb~ (E~9~)oder

· als Teil eines Prädikatskomplexes
...
z.B.
 (4)
 Er versprach seiner Frau, [ihr
einen Netz zu schenken]{.underline}./

 Er
versprach seiner Frau einen Netz .

(5)  Er
denkt daran, [den Plan zu verwirklichen]{.underline}.

 Er
denkt an die Verwirklichung des Plans.

(6)  Er
traut sich nicht [zu widersprechen]{.underline}.

 \*Er
traut sich keinen Widerspruch.

(7)  Ich gedenke, [das morgen zu tun]{.underline}.

 \*Ich
gedenke des morgigen Tuns.

(8)  Es gilt [zu gewinnen]{.underline}.

 \*Es
gilt der Gewinn.

(9)  Es beginnt, [kalt zu werden]{.underline}.
...
z.B.
 (8')
 Es gilt zu gewinnen./ Das gilt es.
...
z.B.
 (10)
 [Es]{.underline} [**gilt**]{.underline} zu *gewinnen*.

 (11)
 [Es]{.underline} [**gilt**]{.underline}, ihn willkommen zu *heißen*.

 (12)
 [Er]{.underline} **pflegt**, samstags seine Einkäufe zu [*erledigen*]{.underline}.

 (13)
 In dieser Gegend **pflegt** [es]{.underline} häufig zu [*regnen*]{.underline}.

Vollverb + infinitivische Evrb (E9) in (10) und
(11).
Modalitätsverb + abhängiger Infinitiv in (12) und (13).
...
z.B.
 (14)
 Er verspricht [ihr]{.underline}, sie zu
besuchen.
 (VV)

 (15)
 \*Das Wetter verspricht [uns]{.underline},
schön zu werden.
 (V~n~)

(16)  Er hat bei ihm nichts zu lachen.
...
(18)  Das Wetter verspricht
schön zu werden./

 \*Das
Wetter verspricht [es/das]{.underline}.
 (V~n~)

(19)  Er verspricht, morgen zu kommen./

  Er verspricht es/das.
 (VV)

(20)  Das verspricht ja heiter zu werden./

 \*Das
verspricht Heiterkeit.
 (V~n~)

(21)  Er versprach, mir etwas zu schenken./
...
fängt an zu regnen.
 ...
 (24)  Der Blumenstrauß fängt an zu welken.

Aber nur:

 (25)  Klaus fängt (damit) an zu singen.

Nur der Infinitiv beim Vollverb ist anaphorisier-/ kommutierbar.

z.B.
 (25')  Klaus fängt [damit]{.underline} an.
...
(26)  Das Problem [ist]{.underline}
kaum zu lösen.

 (27)
 Es [bleibt]{.underline} noch viel für dich zu
tun.

(28)  In diesem Restaurant [bekommt]{.underline} man noch nach 22^00^
etwas zu essen.

 (29)
 Du [kriegst]{.underline} es nichts mehr zu
trinken!

(30)  [Gib]{.underline} mir doch bitte noch etwas zu trinken!

 (31)
 In Köln gibt es viele schöne Kirchen
zu besichtigen.
(...,die man ...)

(32)  Es gab eine Menge zu essen/zum Essen.

Diese Gruppe ist heterogen und zeigt gemäß Engel
(1988: 51 ff) Abweichungen gegenüber den Modalitätsverben:

z.B.
 · Konkurrenzform zum werden-Passiv; +/-E~sub~ (31)

· Infinitiv als Attribut zu E~akk~ (31),(32)
-- es gibt (31,32) + zu-Infinitiv (man +V~f~)
...
Nebensatzverben regieren nie Infinitivsätze.
Zu den Nebensatzverben gibt es
auch gleichlautende Verben mit anderer Bedeutung.
Zu allen Nebensatzverben sind
Perfektformen möglich, Passiv im allgemeinen nicht.

z.B.
 (33)  Man
bedeutete ihr, (dass) das Spiel entschieden sei.

 (34)
 Ich finde, er hat recht.

(35)  Sie fragte sich, ob er das wohl ernst meine.

(36)  Es heißt, Petra sei gestürzt.

(37)  Ich habe mir gesagt, dass da etwas wohl nicht stimmen kann.

(38)  Wähntest du etwa, ich sollte das Leben hassen?

**Infinitivverbkomplexe:** Nebenverben\*, die immer ein anderes Verb im Infinitiv (einschließlich
seiner Satelliten) regieren, jedoch eine andere Subjektgröße als dieses haben.

(± zu-Infinitiv)

z.B.
 (39)  Man
bedeutete **ihr**, den Hut *ab[zu]{.underline}nehmen*.
(gehoben)

 (40)
 Ich fühle **die Erde** [*f*]{.underline} *beben*.

 (41)
 Es gibt **eine Menge** [zu]{.underline} *tun*.

 (42)
 Ich hörte **ihn** [*f*]{.underline} *kommen*.
 (® Fortbewegungsverben)

**Partizipverbkomplexe:** die Verben *kommen, stehen*.
Das
Subjekt des Partizipverbs und das des abhängigen Partizips sind identisch .

z.B.

(43)  Er kam ins Zimmer *geschwankt*.

 (44)
 In diesem Buch steht alles *geschrieben*, was ...

Weitere Beispiele: *Er gibt das Spiel verloren., Wo steht das geschrieben?, Der Brief lag unter
den Büchern versteckt*.
...
(45)  Sie [fand]{.underline} ihn an den
Mauer *lehnen/lehnend*.

 (46)
 Sie [fand]{.underline} ihn *schlafend*.

(47)  Sie [fanden]{.underline} das Kind in Windeln *gewickelt*.

 (48)
 Ich [sah]{.underline} ihn den Ast *absägen*

(49)  Sie sah ihn Nüsse *knackend*
im Zimmer .

 (50)
 Sie wurde total vom Regen *durchnässt* [gesehen]{.underline}.



**Als Prädikatskomplexe auch (in)transitive Verben V~t~ /V~i~ +
Infinitiv \< + Bewegung \>**

z.B.

(51)  Ich [gehe]{.underline} noch heute
in die Stadt *einkaufen*.

 (52)
 [Gehst]{.underline} du mit *baden* ?

(53)  Sie [schickt]{.underline} den Jungen Brötchen *holen*.

 (51') Ich [gehe]{.underline} noch heute in die Stadt, um *ein[zu]{.underline}kaufen*.
...
z.B.
 (54)  Ich
würde heute lieber im Bett *liegen* [bleiben]{.underline}.

 (55)
 Sie [hat]{.underline} unheimlich viel
Krimskrams in ihrem Zimmer *herumliegen*.
...
Verbkomplex.
[Engel & Schumacher]{.underline} (1978: 42 ff) unterscheiden im KVL[°](#_ftn2) folgenden Gruppen:
...
Echt reflexive Verben liegen dann vor, wenn
folgende Kriterien erfüllt sind:

· das Reflexivpronomen ist nicht weglassbar
(Ausnahmen: z.B. Er irrt (sich).);

· der Austausch des Reflexivpronomens gegen
einen anderen sprachlichen Ausdruck (ein anderes Pronomen, eine Nominalphrase,
... ) ist nicht möglich.

z.B.
 (1)
Er weigert [sich]{.underline}, das zu glauben.

 (2) Er hat [sich]{.underline} dem Mädchen
erklärt.
...
· das Reflexivpronomen kommutiert ebenfalls
nicht mit anderen sprachlichen Ausdrücken (Pronomen, Nominalphrasen, ...) oder
der Austausch ergibt eine Bedeutungsveränderung

z.B.
 (3) Er hält ([sich]{.underline}) eine Illustrierte.
...
Ein Reflexivpronomen kann Bestandteil einer (phraseologischen) verbalen
Wendung sein.
...
(6) Er setzt [sich]{.underline} zur
Ruhe.
 [V
+ sich + Präp.
+ NP]

(7) Er führt immer einen
Regenschirm [mit sich]{.underline}.
 [V +
Präp.
+ sich]
...
In reziproker Bedeutung ist das Reflexivpronomen
ersetzbar durch *einander*.

z.B.
 (8) Sie lieben [sich]{.underline}.
- Sie lieben *einander* (Er liebt sie, sie liebt ihn)

Das Reflexivpronomen in (8) hat den Status einer
Ergänzung.
...
Zu unterscheiden sind ein kommutierbares *es* (1) und ein nicht kommutierbares *es*.
(2)-(12).

z.B.
· (1) Das neue Auto ist teuer.
[Es]{.underline}
ist teuer.

 · (2) [Es]{.underline} regnet.

 · (3)
Er nimmt [es]{.underline} mit allen auf

  (4)
Er meint es gut mit dir.

 · (5)
[Es]{.underline} gibt dort keinen Ärger mehr.

  (6)
[Es]{.underline} kam zu einem schweren Verkehrsunfall.

  (7)
[Es]{.underline} handelt sich um deine Anfrage.

  (8)
[Es]{.underline} fehlt (dir) an Mut.

  (9)
[Es]{.underline} kommt auf das Ergebnis an.

 · (10)
[Es]{.underline} wurden 30 Typhusfälle gezählt.

  (11)
[Es]{.underline} ist ein schreckliches Unglück passiert.

  (12)
[Es]{.underline} heißt, dass ihre Firma in Konkurs geht.
...
Verschmelzungsgrad der einzelnen Teile dieser Fügungen.
Die verbabhängigen
Bestandteile (Nomina, Adjektive, Verben, Pronomina) können **nicht als Ergänzungen** beschrieben werden, da die
Anaphorisierungsprobe negativ ausfällt, sondern als Teile des Verbkomplexes.

z.B.
 (1)  Sie steht dem Maler [Modell]{.underline}.
 (E~akk~ - E~1~?)

 \*Sie
steht [es]{.underline} dem Maler.

 (2)
 Ich lasse mich nicht [für dumm]{.underline} verkaufen.
 (E~prp~ - E~4~?)

 \*Ich
lasse mich nicht [dafür]{.underline} verkaufen.

 (3)
 Er hat die Sache [im Griff]{.underline}.
 (E~sit~ -
E~5~?)

 \*Er
hat die Sache [dort]{.underline}.

 (4)  Seine Ausbildung
stand [in Frage]{.underline}.
 (E~sit~ - E~5~?)

 \*Seine Ausbildung stand [dort]{.underline}.


 (5)  Der Plan kommt [zur
Erörterung]{.underline}.
 (E~dir~ - E~6~?)

 \*Der Plan kommt [dorthin]{.underline}.

 (6)  Er hat es im
Leben [weit]{.underline} gebracht.
 (E~adj~ - E~8~?)
...
z.B.
 (7)  Er kam in Gefahr, [sein
Leben zu verlieren]{.underline}.

  Er kam in [Lebens]{.underline}gefahr.

In (7) kommutiert der infinitivische Attributsatz
mit der ersten unmittelbaren Konstituente einer Zusammensetzung.



In (8) kommutiert ein Possesivpronomen mit einem
attributiven Adjektiv, mit einem attributiven Genitiv und mit der ersten
unmittelbaren Konstituente einer Zusammensetzung.

z.B.
 (8)  Das Land steht unter der Kontrolle [des
Militärs]{.underline}.

 Das Land steht unter [seiner]{.underline} Kontrolle.

 Das Land steht unter [militärischer]{.underline} Kontrolle.

 Das Land steht unter [Militär]{.underline}kontrolle.



Soll man die (meist) von den Nomina abhängigen
Elemente als Attribute betrachten, oder soll man sie in Abhängigkeit von der
gesamten Fügung sehen, d.h.
als Ergänzungen (besonders bei den
Funktionalverbgefügen gut vorstellbar -- die Basisverben sind nämlich
kommutierbar).
...
durch Angabe der [syntaktischen]{.underline} Umgebungen der Verben in streng formalen Begriffen ("strenge Subkategorisierungsregeln")
...
Fragen zur Valenzanalyse des Textes *Desperada des Deutschrap*  (https://www.spiegel.de/kultur/musik/haiyti-unser-album-der-woche-a-fccc358a-f75d-4612-b09f-2da442d25cf5), die wir in unserer gemeinsamen Google-Tabelle gemacht haben (https://docs.google.com/spreadsheets/d/14T6rpriQndHjK3KDasWuXjQV5qgujEi3yCm2L1HZ3Y8/edit#gid=0):

1. Nennen Sie die drei häufigsten Hauptverben im Text (nicht die Hilfsverben)! 

2. Welche Verben kamen im Text am häufigsten vor: ein-, zwei- oder dreiwertige Verben? 

3. Welches Satzmuster kam im Text am häufigsten vor? 

4. Beschreiben Sie in einem oder zwei Sätzen, wie Präfixe die Bedeutung des Verbstammes und damit auch die syntaktische Valenz verändern! Illustrieren Sie Ihre Beschreibung mit zwei Beispielen! 
...
1.	Tragen Sie deutsche und slowenische Verben ins zweisprachige Verbvalenzwörterbuch ein (insbesondere solche im Dative)! (gemeinsame Google-Tabelle). Unterscheiden Sie Anzahl und Klasse der Ergänzungen, ob obligatorisch oder fakultativ! 

Adresse der gemeinsamen Google-Tabelle: https://docs.google.com/spreadsheets/d/1DgfJUF0wJuplg5SEI6QPSfwfa642sqckrwf3OTNtW7U/edit#gid=0
